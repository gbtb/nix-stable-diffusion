{ stdenv, lib, fetchFromGitHub, fetchpatch, buildPythonPackage, python,
  cudaSupport ? true, cudaPackages, magma,
  ...
  # Native build inputs
  cmake, util-linux, linkFarm, symlinkJoin, which, pybind11, removeReferencesTo, rocm-runtime,
...
in buildPythonPackage rec {
  ...
  nativeBuildInputs = [
    ...
    ++ lib.optionals rocmSupport [ rocm-runtime ];
